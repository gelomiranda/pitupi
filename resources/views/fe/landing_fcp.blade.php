                  ...
                  <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" id="step1">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                <label class="radio-inline"><input type="radio" value="15" name="optradio" checked="checked">15 Days</label>
                                <label class="radio-inline"><input type="radio" value="30" name="optradio">30 Days</label>
                              </div>
                              <hr/>     
                      ...
                      <div class="tab-pane" role="tabpanel" id="complete">
                          ...
                          <p>Thank you for submitting your application. 
                             Please wait for our loan officer to contact you for validation. 
                             Keep your line open.
                          </p>
                      </div>
    ...
    <script type="text/javascript">
      ...
      $(document).on('ready', function() {      //Initialize tooltips
          ...
          $("#amount").change(function(){
             $("#estimatedAmount").html(computeAmount( $('input[type=radio][name=optradio]:checked').val(), this.value ) + " PHP") ;
          })
