...
@section('content')      
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <h4 class="text-center"><i class="icon-envelope"></i><strong>Join us.</strong></h4>
          <p class="text-center">
          ...
          <div class="cform" id="contact-form">
            ...
            {{ Form::open(array('url' => 'register', 'method' => 'post')) }}
              ...
              <div class="form-group">
                <input type="password" class="form-control" name="c_password" required="required" placeholder="Confirm Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                <div class="validation"></div>
              </div>
